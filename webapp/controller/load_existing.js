window.onload = function() {
    ...
    xhttp.open("GET", "https://287b63b6.ngrok.io/get_players/" + sessionStorage.getItem("email") , true);
...
function deletePlayer() {
    ...
    xhttp.open("POST", "https://287b63b6.ngrok.io/delete_player/" + sessionStorage.getItem("email"), true);
    xhttp.setRequestHeader("Access-Control-Allow-Origin", '*');
...
function loadPlayer() {
    ...
    xhttp.open("POST", "https://287b63b6.ngrok.io/load_player/" + sessionStorage.getItem("email"), true);
    xhttp.setRequestHeader("Access-Control-Allow-Origin", '*');
    xhttp.send(JSON.stringify(player));
}
