...
function getItems() {
    ...
    xhttp.open("GET", "https://287b63b6.ngrok.io/get_inventories/" + sessionStorage.getItem("email") , true);
    xhttp.setRequestHeader("Access-Control-Allow-Origin", '*');
    xhttp.send();
}
...
function sellItem() {
    ...
    xhttp.open("POST", "https://287b63b6.ngrok.io/sell_item/" + sessionStorage.getItem("email"), true);
    xhttp.setRequestHeader("Access-Control-Allow-Origin", '*');
...
function buyItem() {
    ...
    xhttp.open("POST", "https://287b63b6.ngrok.io/buy_item/" + sessionStorage.getItem("email"), true);
    xhttp.setRequestHeader("Access-Control-Allow-Origin", '*');
    xhttp.send(JSON.stringify(item));
}
